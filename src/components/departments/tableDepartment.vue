<template>
          ...
          <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200">
                <tr v-for="item, index of departments" :key="item._id">
      ...
      <el-confirm title="Bo`limni o`chirmoqchisiz. Qarorigiz qattiymi?" text="O`chirilgan ma`lumotlarni qayta tiklab bo`lmaydi."
...
export default {
        ...
        props: ['info'],
        methods:{
          ...mapActions(['changeStatusDepartment', 'removeDepartment']),
          allDepart(){
