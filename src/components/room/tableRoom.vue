<template>
          ...
          <table class="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                ...
                <th scope="col" class="th">Xona raqami</th>
                <th scope="col" class="th">Xona sigimi</th>
                <th scope="col" class="th">Bo'lim nomi</th>
                <th scope="col" class="th">Xolati</th>
                <th scope="col" class="relative py-3.5 pl-3 text-base font-semibold text-gray-900 pr-4 sm:pr-0">Tahrirlash</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
              <tr v-for="item, index of rooms" :key="item._id">
                <td class="td pr-3 font-medium text-gray-900 sm:pl-0">{{ index + 1}}</td>
                <td class="td">{{ item.number }}</td>
                <td class="td">{{ item.maxcount }}</td>
    ...
    <el-confirm title="Xonani o`chirmoqchisiz. Qarorigiz qattiymi?" text="O`chirilgan ma`lumotlarni qayta tiklab bo`lmaydi."
